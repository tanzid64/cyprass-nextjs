      ...
      <section className="flex flex-col gap-4 justify-center items-start md:items-center">
        ...
        {subheading ? (
          <>
            ...
            <p className="dark:text-washed-purple-700 sm:mx-w-[450px] md:text-center">
              {subheading}
            </p>
          </>
        ) : (
          <>
            <h1 className="text-4xl text-left sm:text-6xl sm: max-w-[850px] md:text-center font font-semibold">
              {title}
            </h1>
          </>
        )}
