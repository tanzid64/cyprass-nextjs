  ...
  return (
    <>
      <section className="overflow-hidden px-4 sm:px-6 mt-10 sm:flex sm:flex-col gap-4 md:justify-center md:items-center">
        ...
        />
        {/* Get Cypres Button */}
        <div className="bg-white p-[2px] mt-[6] rounded-xl bg-gradient-to-r from-primary to-brand-primaryBlue sm:w-[360px]">
          <Button
            variant={"secondary"}
      ...
      >
        ...
        <TitleSection
          ...
          pill="Features"
          subheading="Capture your ideas, thoughts, and meeting notes in structured and organized manner"
        />
        <div
          className="mt-10
          max-w-[450px]
